        ...
        <form action="{{ route('employee-management.mark.attendance.store') }}" method="post" class="form_grid_cust" id="FormValidations">
          ...
          <div class="inpus_cust_cs form_grid_dashboard_cust_">
            <div class="form-input">
              ...
              <input type="text" name="purpose" id="purpose" maxlength="100" value="{{ old('purpose') }}" placeholder="Purpose" data-validate="required" data-error="Please enter your purpose.">
            </div>
            <div class="form-input">
            ...
            <div class="form-input">
              ...
              <textarea name="address" id="address" rows="3" placeholder="Address/Location" data-validate="required" data-error="Please enter address.">{{ old('address') }}</textarea>

  ...
  <div class="inner_page_dash__">
    <div class="my-4">
      ...
      <div id="Home" class="tabcontent" style="display: block;">
        <form action="{{ route('employee-management.self.service.store') }}" method="post" id="hrAssignAssetForms" class="form_grid_cust">
          @csrf
          <div class="inpus_cust_cs form_grid_dashboard_cust_">
            <div class="form-input">
              <label class="required-label">Request Type</label>
              <select name="request_type" id="request_type" data-validate="required" data-error="Please choose request type.">
                <option value="">Select request type</option>
                @forelse($reqtype as $reqtypedata)
                <option value="{{$reqtypedata->id}}">{{$reqtypedata->request_type}}</option>
                @empty
                @endforelse
              </select>
            </div>
            <div class="form-input">
              ...
              <select name="ref_checker_id" id="ref_checker_id" data-validate="required" data-error="Please choose checker.">
            ...
            <div class="form-input">
              ...
              <select name="ref_approver_id" id="ref_approver_id" data-validate="required" data-error="Please choose approver.">
                <option value="">---- Choose your manager ----</option>
            ...
            <div class="form-input attachment_payment_proof">
              ...
              <div class="flex gap-[10px]">
                <input id="payment_proof_txt" name="payment_proof_txt" type="text" class="payment_proof_txt" placeholder="Upload additional documents" readonly>
            ...
            <div class="form-input">
              ...
              <textarea name="request_details" id="request_details" rows="3" placeholder="Enter request details" data-validate="required" data-error="Please enter request details."></textarea>
              <small class="form-text text-muted text-red">

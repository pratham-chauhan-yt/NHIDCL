...
<div class="form_bg_inner md:block hidden">
    ...
    <div class="bg_form_">
        ...
        <form class="inpus_cust_cs " method="POST" action="{{ route('twoFactor.verify') }}">
            @csrf
            ...
            <div id="countdown" class="text-muted small text-center" data-seconds="{{ $remainingSeconds }}" data-otp-url="{{ route('twoFactor.index') }}"></div>
        </form>
    </div>
</div>
@endsection
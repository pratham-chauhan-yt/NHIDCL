        ...
        <div class="inner_page_dash__">
            ...
            <div class="my-4">
                <div id="Home" class="tabcontent">
                    ...
                    <hr class="mt-5 mx-12" />
                     @if (auth()->user()->hasRole('Nodal Officer') || auth()->id() == $auditQueryPara->assign_to)
...
@push('style_end')
<link href="{{ asset('public/css/summernote-lite.min.css') }}" rel="stylesheet">
@endpush

@push('scripts')
<script src="{{ asset('public/js/summernote-lite.min.js') }}"></script>

...
<head>
    <meta charset="UTF-8">
    <title>Your One-Time OTP for Email Verification – NHIDCL</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <p>Your One-Time Password (OTP) for email verification on the NHIDCL
            {{ session('moduleName') ?? 'Recruitment Portal' }} is:</p>
        ...
        <p>Regards,<br>
            NHIDCL {{ session('moduleName') ?? 'Recruitment' }} Division</p>

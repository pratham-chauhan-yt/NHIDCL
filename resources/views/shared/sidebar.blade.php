<div class="sidebar">
    <ul class="nav-list ">
        ...
        @endcanany
         ...
         @canany(['apms-create', 'apms-list',
            ...
            <li class="menu-item dropdown {{ request()->is(['employee-management/appraisal/*']) ? 'active' : '' }}">
                ...
                <ul class="dropdown-menu cust_drop">
                  @can('apms-list')
                        <li><a class="dropdown-item" href="{{ route('employee-management.appraisal.appraisallist') }}">View Appraisal list</a></li>
                    @endcan

                       @can('apms-list')
                        <li><a class="dropdown-item" href="{{ route('employee-management.appraisal.assign') }}">Assign to Cycle</a></li>
                    @endcan
                    @hasrole(['HR', 'HR Resource Pool'])
                   @can('apms-create')
                        <li><a class="dropdown-item" href="{{ route('employee-management.appraisal.create') }}">Create Appraisal</a></li>
                    @endcan
                    @endhasrole
                      @can('apms-list')
                        <li><a class="dropdown-item" href="{{ route('employee-management.hr.list') }}">Employee Appraisal List</a></li>
                    @endcan
                </ul>
            </li>
        @endcanany
        ...
        @hasrole('Super Admin|HR-Employee')
            ...
            <li class="menu-item dropdown {{ request()->is('employee-management*') ? 'active' : '' }}">
                ...
                <ul class="dropdown-menu cust_drop">
                    ...
                    @endcan
                       ...
                       @can('self-appraisal')
                        <li><a class="dropdown-item" href="{{ route('employee-management.selfappraisal.selfappraisallist') }}">Self Appraisal list</a></li>
                    @endcan

                      @can('employee-appraisal-by-manager')
                        <li><a class="dropdown-item" href="{{ route('employee-management.manager.employees') }}">Employee Appraisal list</a></li>
                    @endcan
                </ul>
            </li>
        @endcanModule
        ...
        @hasrole('Trainer|HR|Employee')
        <li class="menu-item dropdown {{ request()->is(['training-management*']) ? 'active' : '' }}">
            <a href="javascript:void(0);" class="menu-link">
                <img src="{{ asset('public/images/MDI-information-outline.svg') }}" alt="User Management">
                <span class="links_name">Training Management</span>
            </a>
            <ul class="dropdown-menu cust_drop">
                @hasrole('HR')
                <li><a class="dropdown-item" href="{{ route('training.hr.dashboard') }}">Dashboard</a></li>
                <li><a class="dropdown-item" href="{{ route('sessions.index') }}">Trainer Session</a></li>
                <li><a class="dropdown-item" href="{{ route('hr.training.requests') }}">Training Request</a></li>
                <li><a class="dropdown-item" href="{{ route('hr.training.budget') }}">Training Budget</a></li>
                @endhasrole
                @hasrole('Employee')
                <li><a class="dropdown-item" href="{{ route('training.employee.dashboard') }}">Dashboard</a></li>
                <li><a class="dropdown-item" href="{{ route('training.employee.sessions') }}">Training Sessions</a></li>
                <li><a class="dropdown-item" href="{{ route('training.employee.enrolled') }}">Training Enrolled</a></li>
                <li><a class="dropdown-item" href="{{ route('training.index') }}">Training Request</a></li>
                @endhasrole
                @hasrole('Trainer')
                <li><a class="dropdown-item" href="{{ route('sessions.index') }}">Trainer Session</a></li>
                <li><a class="dropdown-item" href="{{ route('trainer.profile') }}">Trainer Profile</a></li>
                @endhasrole
            </ul>
        </li>
        @endhasrole

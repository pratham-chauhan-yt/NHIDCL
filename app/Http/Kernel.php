...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        ...
        \App\Http\Middleware\AllowGeolocation::class,
    ];
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            \App\Http\Middleware\NoCacheHeaders::class, //Add here
            \App\Http\Middleware\SecurityHeaders::class,
            \App\Http\Middleware\EnsureUserExists::class,
            \App\Http\Middleware\BlockXSSMiddleware::class,
            // \App\Http\Middleware\LogUserRoute::class,
        ],
    ...
    protected $routeMiddleware = [
        ...
        'check.steps' => \App\Http\Middleware\ApplicationStepCompleted::class,
        'block.xss' => \App\Http\Middleware\BlockXSSMiddleware::class,
        'module.access' => \App\Http\Middleware\CheckModuleAccess::class,
        'allow.geolocation' => \App\Http\Middleware\AllowGeolocation::class,
    ];

    protected function schedule(Schedule $schedule)
    {
        $schedule->command('task:repeat')->daily(); // or ->everyMinute(), etc.
    }
}

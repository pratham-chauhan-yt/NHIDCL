...
class GrievanceController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        return view("grievance.dashboard", compact("header", "sidebar"));
    }
    ...
    public function index(Request $request)
    {
        ...
        $header = TRUE;
        $sidebar = TRUE;
        return view("grievance.index", compact("header", "sidebar"));
    }
    ...
    public function create()
    {
        ...
        $user_responders = User::select("id", "name", "email")
            ...
            ->get();
        return view("grievance.create", compact("header", "sidebar", 'user_responders'));
    }
    ...
    public function store(GrievanceRequest $request)
    {
        try {
            ...
            return redirect()->route("grievance.index")->with("error", $e->getMessage());
        }
    }

...
<section class="home-section">
    ...
    <div class="inner_page_dash__ banner_cust_m ">
        <div class="left_side px-4">
            ...
            <form method="POST" id="change-password-form" action="{{ route('recruitment-portal.recruitment.update.password') }}">
                @csrf
                {{-- Current Password --}}
                <div class="inpus_cust_cs grid check_box_input mt-4">
                    <div>
                        ...
                        <input type="password" id="current_password" name="current_password"
                            ...
                            required autocomplete="off" pattern="^(?=.*[A-Z])(?=.*\d)(?=.*[\W_]).{8,}$" required>
                ...
                <div class="inpus_cust_cs grid check_box_input mt-4">
                    <div>
                        ...
                        <input type="password" id="new_password_confirmation" name="password_confirmation"
                            ...
                            required autocomplete="off" pattern="^(?=.*[A-Z])(?=.*\d)(?=.*[\W_]).{8,}$">

...
@section('auth_content')
    <div class="bg_form_">
        ...
        <form class="inpus_cust_cs" id="login-form" method="POST" action="{{ route('recruitment.auth.login') }}">
            @csrf
            <input type="hidden" name="action" value="recruitment">
            ...
            <div class="flex items-center justify-between pt-2">
                ...
                <a href="{{ route('recruitment.password.request') }}" class="forgot_pads_cust">Forgot password?</a>
            </div>
           ...
           <span class="text-red-500 dark:text-red-500 custom_font_size">If you are not registered, kindly register yourself first.</span>
            <a href="{{ route('recruitment.auth.registration') }}" class="gray_btn hover-effect-btn bg-[#AEAAA6] text-center">Registration</a>
        </form>
    </div>
    </div>
@endsection

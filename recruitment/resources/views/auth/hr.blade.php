                    ...
                    <div class="bg_form_">
                        ...
                        @csrf
                            ...
                            <div class="relative  items-center">
                                ...
                                id="login" value="{{ old('login') }}" aria-describedby="emailHelp" placeholder="{{ __('Employee ID') }}"
                            ...
                            <div class="relative  items-center">
                                ...
                                <input type="password" class="form-control login-input-password @error('password') is-invalid @enderror"
                                    id="password" name="password" aria-describedby="textHelp" placeholder="********">
                            ...
                            <div class="">
                                ...
                                <div class="flex items-center gap-4">
                                    ...
                                    <div class="refresh">
                                        <img class="btn-refresh cursor-pointer" src="{{asset('/images/refresh.png')}}" alt="refresh" type="button">
                                    </div>
                                    <div class="input_f">
                            ...
                            <a href="{{route('auth.registration')}}" class="gray_btn hover-effect-btn bg-[#AEAAA6]" style="text-align:center;">Registration</a>
                        </form>
                    </div>
            </div>

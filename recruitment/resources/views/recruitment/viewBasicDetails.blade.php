...
<div class="container-fluid md:p-0">
    <div class="top_heading_dash__">
        ...
        <div class="plain_dlfex bg_elips_ic">
            <a href="{{route('recruitment.detail')}}"><button class="hover-effect-btn fill_btn" type="button">Add basic Details
            </button></a>
        </div>
    </div>
</div>
            <div class="container inner_page_dash__ mt-[20px]">
                <h4 class="text-[24px] py-[10px] font-semibold">Candidate Lists</h4>
                    <table id="candidateTable" class="data_bg_table cust_table__ table_sparated">
                            <thead class="">
                                <tr>
                                    <th>Sl no</th>
                                    <th>First Name</th>
...
<!-- #cdn -->
    ...
    ajax: {
        url: '{{ route('recruitment.viewBasicDetails') }}',  // Correct route URL
        type: 'GET',
        data: function(d) {
    ...
    columns: [
        ...
        {data: 'email_id', name: 'email_id', orderable: false},
        {data: 'address', name: 'address', orderable: false},
        {data: 'nationality', name: 'nationality', orderable: false},
        {data: 'applied_for', name: 'applied_for', orderable: false},

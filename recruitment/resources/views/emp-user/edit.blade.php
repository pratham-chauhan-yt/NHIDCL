    ...
    <section class="home-section ">
        <div class="container-fluid md:p-0">
            <div class="top_heading_dash__">
                <div class="main_hed">{{ __('Edit User / Employee') }}</div>
        ...
        @endif
            ...
            <div class="inpus_cust_cs grid check_box_input grid-cols-4 gap-[30px] mt-4">
                <div class="">
                    ...
                    <input type="hidden" class="form-control" name="id" id="id" value="{{ $employeelist->id }}">
                </div>
                <div class="">
            ...
            <div class="inpus_cust_cs grid check_box_input grid-cols-4 gap-[30px] mt-4">
                ...
                <div class="">
                    ...
                    <select name="userid_status" class="form-select" id="userid_status">
                        <option value="">{{ __('Choose...') }}</option>
                ...
                <div class="">
                    ...
                    <select name="office_type" class="form-select" id="office_type">
                        <option value="">{{ __('Choose...') }}</option>

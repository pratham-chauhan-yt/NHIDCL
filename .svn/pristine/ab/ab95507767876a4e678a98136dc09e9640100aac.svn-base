...
@section('dashboard_content')
    ...
    <div class="inner_page_dash__">
        <div class="my-4 ">
            ...
            <div id="Home" class="tabcontent">
                ...
                <div id="advertismentList" data-archsear="0" data-arch="0" data-sear="0" data-len="0"
                    class="candidat_cust-container">
    ...
    <div id="popup-modal" class="custom_modal_latest hidden">
            ...
            <div class="modal-body mt-3">
                <div class="applicat_cust-container">
                    <div class="applicat_cust-row">
                        ...
                        <div class="applicat_cust-value" id="job_title"></div>
                    </div>
                    <div class="applicat_cust-row">
                        <div class="applicat_cust-label">Job Description</div>
                        <div class="applicat_cust-value" id="job_description"></div>
                    </div>
                </div>
                <div class="table-responsive">
                    <table class="cust_table__ table_sparated">
                        ...
                        <tbody>
                            <tr>
                                <td id="number_of_required_resources"></td>
                                <td id="minimum_work_experience"></td>
                                <td id="duration_of_engagement"></td>
                                <td id="view_advertisment_details"></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
...
@endsection
@push('scripts')
    <script src="{{ asset('public/js/resource-pool/candidate/advertisment.js') }}"></script>
@endpush

                ...
                <div class="chart_grid_custom">
                    <div class="bg_chart_card">
                        ...
                        <div class="chart-container" style="position: relative; width: 604px; height: 258px">
                            <canvas class="justify-self-center" id="myChart1" data-completed="{{ $statusCounts['completed'] }}" data-in-progress="{{ $statusCounts['in_progress'] }}" data-pending="{{ $statusCounts['pending'] }}"></canvas>
                        </div>
                    </div>
                    <div class="bg_chart_card">
                        <div class="heading_chart_">
                        ...
                        <div class="chart-container" style="position: relative; width: 604px; height: 258px">
                            <canvas class="justify-self-center" id="myChart2"
                                ...
                                data-completed='@json($statusCounts["priority"]->pluck("completed"))'
                                data-in-progress='@json($statusCounts["priority"]->pluck("in_progress"))'

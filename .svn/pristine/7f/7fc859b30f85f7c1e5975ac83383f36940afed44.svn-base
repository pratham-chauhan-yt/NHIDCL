    ...
    <section class="home-section ">
        <div class="container-fluid md:p-0">
            <div class="top_heading_dash__">
                <div class="main_hed">Edit Knowledge Base Query</div>
            ...
            <div class="my-4 ">
                ...
                <div id="appendKnowledgebase" class="tabcontent">
                    <form class="form_grid_cust" action="{{ route('qms.store-knowledge-base-query') }}" method="POST"
                        ...
                        @csrf
                        <input type="hidden" name="konwladgebase_id" value="{{ $data->id }}">
                        <div class="inpus_cust_cs form_grid_dashboard_cust_">
                            <div class="">
                                <label class="required-label">Title/Subject</label>
                                <input type="text" class="" name="title" value="{{ $data->title }}"
                            ...
                            <div class="">
                                ...
                                <input type="text" class="" name="meta_title" value="{{ $data->meta_title }}"
                                    placeholder="Enter your meta title title here...">
                                @error('meta_title')
                                    <div class="error-message">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="">
                                ...
                                <textarea class="" rows="2" name="description" placeholder="Enter your query description here...">{{ $data->description }}</textarea>
                                @error('description')
                                    <div class="error-message">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="">
                                ...
                                <textarea class="" rows="2" name="meta_description" placeholder="Enter your query description here...">{{ $data->meta_description }}</textarea>
                            ...
                            <div class="">
                                ...
                                <div class="flex gap-[10px]">
                                    <input type="text" id="uploaded_knowledgebase_file"
                                        name="uploaded_knowledgebase_file" placeholder="Upload Image"
                                        class="uploaded_knowledgebase_file" readonly>
                                    <label class="upload_cust mb-0 hover-effect-btn"> Upload File
                                        <input type="file" id="upload_knowledgebase_file"
                                            name="upload_knowledgebase_file" class="hidden upload_knowledgebase_file">
                                        <input type="hidden" id="knowledgebase_file" name="knowledgebase_file"
                                            value="{{ $data->image }}">
                                    </label>
                                </div>
                                 @if (isset($data->image))
                                    ...
                                    <a href="{{ $FileUrl }}" target="_blank" data-bs-toggle="tooltip"
                                        ...
                                        <i class="fa fa-file mx-1" aria-hidden="true"></i> View uploaded file
                                    </a>
                                @else

            	...
            	<div class="my-4 ">
                    ...
                    <div id="Home" class="tabcontent">
                    	<div class="parrent_dahboard_ chart_c inner_body_style inner_pages mt-0">
                    		<div class="">Advertisement Details</div>
                    	</div>
                                ...
                                <div class="upload_advertisement">
                                    ...
                                    <div class="flex gap-[10px] upload_file_div">
                                        ...
                                        <label class="upload_cust mb-0 hover-effect-btn"> Upload File
                                            <input type="file" name="advertisement_file" class="hidden">
                                        </label>
                                    </div>
                                    <a target="_blank" href="{{route('recruitment.advertisement.file-preview',$edit_record->id)}}"><span> Click Here For Preview</span></a>

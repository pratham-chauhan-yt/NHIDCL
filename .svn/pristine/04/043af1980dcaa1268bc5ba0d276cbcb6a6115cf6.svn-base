...
class ResetPasswordController extends Controller
{
    ...
    */
    ...
    {   
        ...
        $decryptedRecNewPassword = decryptPassword($request->input('password'), session('salt'));
        ...
        $request->merge([
            'password' => $decryptedRecNewPassword,
        ...
        $user->password = Hash::make($decryptedRecNewPassword);
        $user->save();

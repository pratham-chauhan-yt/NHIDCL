            ...
            <div class="inner_page_dash__">
                <div class="my-4 ">
                    ...
                    <div id="Post" class="tabcontent">
                        ...
                        <form class="recruitmentPostForm" method="POST" action="{{route('recruitment-portal.post.store')}}">
                            @csrf
                            <div class="">
                            ...
                            <div class="inpus_cust_cs form_grid_dashboard_cust_">
                                ...
                                <div class="">
                                    ...
                                    <option value="{{$val->id}}">{{$val->fetch_year}}</option>
                                    @empty
                                    <option value="2025">2025</option>
                                    @endforelse
                                    </select>
                                ...
                                <div class="">
                                    ...
                                    <textarea  name="specific_requirement_of_post" rows="3" cols="3" class="" placeholder="Dictation of 10 minutes at the speed of 100 words per minute in Shorthand (English/Hindi) and transcription time (on computer only) is 50 minutes for English and 65 minutes for Hindi."></textarea>
                            ...
                            <div class="inpus_cust_cs form_grid_dashboard_cust_">
                                <div class="">
                                    ...
                                    <div class="grid grid-cols-2 gap-[10px]">
                                        <input type="number" name="min_age_limit" placeholder="18" class="">

                                        @error('min_age_limit')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                        @enderror

                                        <input type="number" name="max_age_limit" placeholder="60" class="">
                                ...
                                <div class="">
                                    ...
                                    <input class="" name="required_experience" placeholder="3"/>
                                ...
                                <div class="">
                                    ...
                                    <textarea cols="5" rows="3" name="eligibility_criteria"></textarea>
                            ...
                            <div class="button_flex_cust_form">
                                <button class="hover-effect-btn fill_btn" type="submit" id="">
                                    Submit
                                </button>
                            </div>
                        </form>

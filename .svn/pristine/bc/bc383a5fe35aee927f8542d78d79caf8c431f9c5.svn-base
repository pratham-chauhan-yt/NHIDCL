    ...
    <section class="home-section ">
        <div class="container-fluid md:p-0">
            <div class="top_heading_dash__">
                <div class="main_hed">Create Query/Para</div>
            ...
            <div class="my-4 ">
                ...
                <div id="Home" class="tabcontent">
                    <div class="parrent_dahboard_ chart_c inner_body_style inner_pages mt-0">
                        <div class="">Create New Audit Query</div>
                    </div>
                    ...
                    <form class="form_grid_cust" action="{{ route('audit-management.store') }}" method="post"
                        ...
                        <div class="inpus_cust_cs form_grid_dashboard_cust_">
                            <div class="">
                                ...
                                <textarea rows="1" class="" name="subject" placeholder="Subject of audit query">{{ old('subject') }}</textarea>
                                @error('subject')
                            ...
                            <div class="">
                                ...
                                <input type="text" class="" name="letter_no" id="letter_no"
                                    placeholder="Letter No." value="{{ old('letter_no') }}">
                                @error('letter_no')
                                    <div class="error-message">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="">
                                <label class="required-label">Letter Date</label>
                                <input type="date" class="" name="letter_date" id="letter_date" placeholder="Letter Date"
                            ...
                            <div class="">
                                <label class="required-label">From/To Date (Period covered in audit)</label>
                                <div class="grid grid-cols-2 gap-[10px]">
                                    <input type="date" class="" name="from_date" id="from_date" value="{{ old('from_date') }}">
                                    @error('from_date')
                                        <div class="error-message">{{ $message }}</div>
                                    @enderror
                                    <input type="date" class="" name="to_date" id="to_date" value="{{ old('to_date') }}">
                                    @error('to_date')
                                        <div class="error-message">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="">
                                ...
                                <select class="form-select" name="location">
                                    ...
                                    @foreach ($refProjectState as $projectState)
                                        <option value="{{ $projectState->id }}">{{ $projectState->state_name }}</option>
                                    @endforeach
                                </select>
                                @error('location')
                                    <div class="error-message">{{ $message }}</div>
                            ...
                            <div class="">
                                ...
                                <input type="text" class="" name="audit_year" placeholder="YYYY-YYYY"
                                    value="{{ old('audit_year') }}">
                                @error('audit_year')
                                    <div class="error-message">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="">
                                <label class="required-label">Audit Level</label>
                                <select class="form-select" name="audit_level">
                                    <option value="">Select audit level</option>
                                    @foreach ($refAuditLevel as $level)
                                        <option value="{{ $level->id }}">{{ $level->audit_level }}</option>
                                    @endforeach
                                </select>
                                @error('audit_level')
                                    <div class="error-message">{{ $message }}</div>
                            ...
                            <div class="">
                                ...
                                <select class="form-select" name="audit_type">
                                    ...
                                    @foreach ($refAuditType as $type)
                                        <option value="{{ $type->id }}">{{ $type->audit_type }}</option>
                                    @endforeach
                                </select>
                                @error('audit_type')
                                    <div class="error-message">{{ $message }}</div>
                            ...
                            <div class="attachment_section_upload_pdf">
                                <label class="required-label">Upload PDF File (<span style="font-size: 10px;">Max 1MB &
                                        file should be PDF</span>)</label>
                                ...
                                <div id="pdf_file-error" class="error-message"></div>
                            </div>
                            ...
                            <div class="attachment_section_upload_word">
                                ...
                                <div class="flex gap-[10px]">
                                    ...
                                    <label class="upload_cust mb-0 hover-effect-btn"> Upload File
                                        ...
                                        <input type="hidden" id="word_file" name="word_file" value="">
                                    </label>
                                </div>
                                @error('upload_word')
                                    <div class="error-message">{{ $message }}</div>
                        ...
                        <div class="button_flex_cust_form">
                            ...
                            <button class="hover-effect-btn fill_btn" type="submit"> Create </button>
                            <!-- Modal toggle -->
                ...
                <div id="News" class="tabcontent">
                    ...
                    <form class="form_grid_cust" action="{{ route('audit-management.store-audit-para') }}"
                        method="post" id="createAuditPara">
                        @csrf
                        <div class="inpus_cust_cs form_grid_dashboard_cust_">
                            <div class="">
                                <label class="required-label">Audit Year</label>
                            ...
                            <div class="">
                                <label class="required-label">Brief Report/Para</label>
                                <textarea rows="1" class="" name="brief_para" placeholder="Brief"></textarea>
                            </div>
                            <div class="">
                                <label class="required-label">Query Type</label>
                                <select class="" name="query_type">
                                    <option value="">Select Query Type</option>
                                    @foreach ($refAuditQueryType as $queryType)
                                        <option value="{{ $queryType->id }}">{{ $queryType->query_type }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="">
                                <label class="required-label">Part</label>
                                <select class="" name="ref_part_id">
                                    <option value="">Select Part</option>
                                    @foreach ($paraParts as $part)
                            ...
                            <div class="attachment_section_upload_para_pdf">
                                ...
                                <div class="flex gap-[10px]">
                                    <input type="text" id="uploaded_para_pdf" name="uploaded_para_pdf"
                                        placeholder="Upload Image" class="uploaded_para_pdf" readonly>

                                    <label class="upload_cust mb-0 hover-effect-btn"> Upload File
                                        <input type="file" id="upload_para_pdf" name="upload_para_pdf"
                                            class="hidden upload_para_pdf">
                                        <input type="hidden" id="para_pdf_file" name="para_pdf_file" value="">
                                    </label>
                                </div>
                                <div id="pdf_para_file-error" class="error-message"></div>
                            </div>
                            ...
                            <div class="attachment_section_upload_para_word">
                                <label>Upload Word File (<span style="font-size: 10px;">Max 2MB & file should be DOC or
                                        DOCX</span>)</label>
                                <div class="flex gap-[10px]">
                                    <input type="text" id="uploaded_para_word" name="uploaded_para_word"
                                        placeholder="Upload Word File" class="uploaded_para_word" readonly>
                                    <label class="upload_cust mb-0 hover-effect-btn"> Upload File
                                        <input type="file" id="upload_para_word" name="upload_para_word"
                                            class="hidden upload_para_word">
                                        <input type="hidden" id="para_word_file" name="para_word_file" value="">
                                    </label>
                                </div>
                            ...
                            <div class="">
                                ...
                                <select class="" name="office">
                                    ...
                                    @foreach ($officeTypes as $office)
                                        <option value="{{ $office->id }} ">{{ $office->office_type_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="">

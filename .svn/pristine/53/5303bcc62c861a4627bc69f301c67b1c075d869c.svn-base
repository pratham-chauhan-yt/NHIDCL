<header>
    <div class="header_parent_cust">
        <div class="container main_header">
            <div class="logo_cust">
                <a href="https://www.nhidcl.com/" class="text-blue-600 fs-14 fw-700">Back to NHIDCL Website</a>
                <a href="{{ route('recruitment.login') }}"> <img src="{{ asset('public/images/logo.png') }}" alt="NHIDCL Logo"></a>

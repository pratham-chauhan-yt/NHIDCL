...
@section('dashboard_content')
            ...
            <div class="inner_page_dash__">
            	<div class="my-4 ">
                    ...
                    <div id="Home" class="tabcontent">
                        ...
                        <form class="form_grid_cust" method="POST" action="{{route('recruitment.advertisement.store')}}" id="advertisementForm">
                        @csrf
                            <div class="inpus_cust_cs form_grid_dashboard_cust_">
                                ...
                                <div>
                                    ...
                                    <input type="date"  name="as_on_date" value="{{ old('as_on_date') }}"/>
									@error('as_on_date')
									<div class="invalid-feedback d-block">{{ $message }}</div>
									@enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="datetime-local"  name="expiry_datetime" value="{{ old('expiry_datetime') }}"/>
                                ...
                                <div class="upload_advertisement">
                                    ...
                                    <div class="flex gap-[10px] upload_file_div">
                                        <input type="text" class="upload_advertisement" name="advertisement_file" placeholder="Upload documents" disabled="">
                                        <label class="upload_cust mb-0 hover-effect-btn"> Upload File
                                            <input type="file" name="upload_advertisement" class="hidden">
                                        </label>
                                    </div>
    ...
    <div id="News" class="tabcontent">
    	...
    	<div class="job_poster_grid_cust">
    		...
    		{{--<div class="job_posted_cust">
    			<h4 class="">Applications invited in On-line mode for the posts of Associate and Consultant on private entities in NHIDCL</h4>
    			<div class="mb-[10px] cust_p pt-[5px]">
    				<p>Active Until: <span> Jan 31, 2025</span></p>
    			</div>
    			<div class="cust_points_jobs mt-[10px] justify-end">
    				<span class=""><a href="#">Edit</a></span>
    				<span class=""><a href="#">View</a></span>
    				<span style="background: rgb(202, 21, 21); color: white;"><a href="#">Delete</a></span>
    			</div>
    		</div>
...
{!! JsValidator::formRequest('App\Http\Requests\Recruitment\AdvertisementRequest', '#advertisementForm'); !!}
...
// = document.querySelector('.upload_advertisement').;
// console.log();
</script>
@endpush

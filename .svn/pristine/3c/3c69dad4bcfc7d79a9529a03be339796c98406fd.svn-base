...
@section('dashboard_content')
    <div class="container-fluid md:p-0">
        <div class="top_heading_dash__">
            <div class="main_hed">Receive or Refer Back BG</div>
        </div>
    </div>
        ...
        <div class="my-4 ">
            ...
            <div id="Home" class="tabcontent">
                <div class="table_over">
                    <table class="cust_table__ table_sparated" id="receive-table">
                        <thead class="">
                            <tr>
                                <th>#</th>
                                <th>BG Id</th>
    ...
    <div id="bg-receive-modal" class="custom-modal" style="display:none;">
        <form class="form_grid_cust" id="bg-received-form" method="POST">
            @csrf
            @method('put')
            <h2>Receive BG</h2>
...
@push('scripts')
    ...
    {{-- <script src="{{ asset('/public/js/flowbit.min.js') }}"></script> --}}
@endpush

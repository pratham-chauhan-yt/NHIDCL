...
class AttendeeController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        return view("attendee.dashboard", compact("header", "sidebar"));
    }
    ...
    public function index(Request $request)
    {
        ...
        $header = TRUE;
        $sidebar = TRUE;
        return view("attendee.index", compact("header", "sidebar"));
    }
    ...
    public function create()
    {
        ...
        $user_responders = User::select("id", "name", "email")
            ...
            ->get();
        return view("attendee.create", compact("header", "sidebar", 'user_responders'));
    }
    ...
    public function store(GrievanceRequest $request)
    {
        try {
            ...
            return redirect()->route("attendee.index")->with("error", $e->getMessage());
        }
    }
    ...
    public function edit(string $id)
    {
        try {
            ...
            return view('attendee.edit', compact('grievance', 'header', 'sidebar'));
        } catch (\Exception $e) {
